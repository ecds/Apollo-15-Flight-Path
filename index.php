    ...
    <div class="uk-flex-row">
      <div uk-grid class="uk-grid uk-child-width-1-2 ">
        ...
        <div class="svg-collection">
          ...
          <!-- <object data="/themes/bigpicture/images/ship3b.svg" id="ship" class="ship" type="image/svg+xml"></object> -->
          <!-- <object data="/themes/bigpicture/images/ship4.svg" id="lm" class="lm" type="image/svg+xml"></object> -->
        </div>
        <!-- right column -->
