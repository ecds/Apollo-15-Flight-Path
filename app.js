...
class Apollo15FlightPath extends Component {
    constructor(options) {
        super(options);
        this.loadPath();
    }
    loadPath() {
        ...
        window.addEventListener("scroll", e => {
            ...
            console.log(this.flightPath.getPointAtLength(drawLength));
...
var __ui_components_Apollo15FlightPath_template__ = { "id": "zKn9jDXk", "block": "{\"symbols\":[],\"statements\":[],\"hasEval\":false}", "meta": { "specifier": "template:/apollo-15-flight-path/components/Apollo15FlightPath" } };

var moduleMap = { 'component:/apollo-15-flight-path/components/Apollo15FlightPath': Apollo15FlightPath, 'template:/apollo-15-flight-path/components/Apollo15FlightPath': __ui_components_Apollo15FlightPath_template__ };

var resolverConfiguration = { "app": { "name": "apollo-15-flight-path", "rootName": "apollo-15-flight-path" }, "types": { "application": { "definitiveCollection": "main" }, "component": { "definitiveCollection": "components" }, "component-test": { "unresolvable": true }, "helper": { "definitiveCollection": "components" }, "helper-test": { "unresolvable": true }, "renderer": { "definitiveCollection": "main" }, "template": { "definitiveCollection": "components" } }, "collections": { "main": { "types": ["application", "renderer"] }, "components": { "group": "ui", "types": ["component", "component-test", "template", "helper", "helper-test"], "defaultType": "component", "privateCollections": ["utils"] }, "styles": { "group": "ui", "unresolvable": true }, "utils": { "unresolvable": true } } };
...
app.renderComponent('Apollo15FlightPath', containerElement, null);
app.boot();
